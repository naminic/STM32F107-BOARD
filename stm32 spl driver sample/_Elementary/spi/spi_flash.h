...
#define SPI_FLASH_CS             GPIO_Pin_11
#define SPI_FLASH_CS_GPIO        GPIOD
#define SPI_FLASH_CS_GPIO_CLK    RCC_APB2Periph_GPIOD
...
#define DF_CS_inactive    GPIO_SetBits(SPI_FLASH_CS_GPIO, SPI_FLASH_CS);
#define DF_CS_active      GPIO_ResetBits(SPI_FLASH_CS_GPIO, SPI_FLASH_CS);
